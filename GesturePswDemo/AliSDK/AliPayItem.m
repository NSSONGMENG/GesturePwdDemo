...
- (CAShapeLayer *)triangleLayer
{
    if (_triangleLayer==nil) {
        ...
        _triangleLayer.fillColor = GESTUREPSW_ALERT_TEXTCOLOR.CGColor;
...
- (void)selectUI
{
    self.innerLayer.fillColor    = GESTUREPSW_ALERT_TEXTCOLOR.CGColor;
    self.outterLayer.strokeColor = GESTUREPSW_ALERT_TEXTCOLOR.CGColor;
}

- (void)wrongUI
{
    self.innerLayer.fillColor    = GESTUREPSW_WRONGCOLOR.CGColor;
    self.outterLayer.strokeColor = GESTUREPSW_WRONGCOLOR.CGColor;
}
